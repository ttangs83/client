    ...
    <div class="container">
      ...
      <div class="mb-3 row">
        <div class="col-4 d-grid p-1">
          <button type="button" class="btn btn-lg btn-primary" @click="productInsert"> 저장하기 </button>
        </div>
        <div class="col-4 d-grid p-1">
          <button type="button" class="btn btn-lg btn-primary" @click="goToList"> 취소하기 </button>
        </div>
      </div>
    </div>
  </main>
